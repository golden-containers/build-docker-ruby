...
echo "LABEL org.opencontainers.image.description=\"https://github.com/golden-containers/build-docker-ruby/actions/workflows/build.yml\"" >> 3.0/bullseye/Dockerfile
